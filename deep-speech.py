...
# Original article: https://github.com/scgupta/yearn2learn/blob/master/speech/asr/deepspeech/ds-transcriber.py
...
DEEPSPEECH_ROOT_DIR = 'ds06'
DEEPSPEECH_MODEL_DIR = os.path.join(DEEPSPEECH_ROOT_DIR, 'deepspeech-0.6.0-models')
